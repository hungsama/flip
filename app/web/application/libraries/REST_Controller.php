...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
    ...
    public function response($data = NULL, $http_code = NULL, $continue = FALSE)
    {
        ...
        // Otherwise (if no data but 200 provided) or some data, carry on camping!
            ...
            elseif (method_exists($this->format, 'to_'.$this->response->format)) {
                ...
                header('Content-Type: application/json; charset=' . strtolower($this->config->item('charset')));

                $output = $this->format->factory($data)->{'to_json'}();
            }
    ...
    protected function _get_msg_err($error_code=0)
    {
        switch ($error_code) {
            case 0:
                $msg = 'Success';
            ...
            case 3:
                ...
                break;
            case 4:
                $msg = 'Login faild, please try again';
                break;
            case 999:
                $msg = 'The data not found';
                break;
            default:
                $msg = 'Not match error';
                break;
